        ...
        <div className="both-container">
            <div className="container-get_hungry-left">
                <div className="div-text">
                    ...
                    <div className="heart"><img src={img1}/></div>
                </div>
            ...
            <div className="container-get_hungry-right">
                <div>
                    <p className="choosing-text">By choosing our box catering at your door, you can be sure that your ready meals will be healthy and tasty.</p>
                </div>
                <div className="cycle">
                    <div className="class">
                        <div className="cycle-one"><img src={img5}/></div>
                        <div className="box">
                            <div>
                                <img src={img7}/>
                            </div>
                    ...
                    <div className="class-two">
                        <div className="cycle-two"><img src={img2}/></div>
                        <div className="box">
                            <div>
                                <img src={img3}/>
                            </div>
                            <div>
                                ...
                                <p>Qui blanditiis praesentium voluptatum deleniti atque veniet ut et voluptates repudiandae</p>
                            </div>
                        </div>
                    </div>

                    <div className="class-three">
                        <div className="cycle-three"><img src={img8}/></div>
                        <div className="box">
                            <div>
                                <img src={img4}/>
                            </div>
