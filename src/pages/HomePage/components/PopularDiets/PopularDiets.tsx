...
export const PopularDiets= () =>{
    return(
        ...
        <div className="arrows">
            <button className="arrow1"><img alt="errorimage" className="picarrow1" src={arrowleft}/></button>
            <button className="arrow2"><img alt="errorimage" className="picarrow2" src={arrowright}/></button>
        </div>
        <div className="fourdiets">
            <div className="diet">
               <img alt="errorimage" src={Maskgroupslim} />
            ...
            <div className="diet">
                <img alt="errorimage" src={Maskgroupfit} /> 
             ...
             <div className="diet">
                <img alt="errorimage" src={Maskgroupvegan} /> 
             ...
             <div className="diet">
                <img alt="errorimage" src={Maskgroupketo} /> 
